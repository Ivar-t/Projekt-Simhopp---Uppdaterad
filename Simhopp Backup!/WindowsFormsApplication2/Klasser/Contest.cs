...
namespace WindowsFormsApplication2
{
    public class Contest
    {
        ...
        public double JudgeSum(Judge judge1, Judge judge2, Judge judge3, double difficulty) //ej testad
        {
            TotJ = (judge1.SetPoints(1.0) + judge2.SetPoints(1.0) + judge3.SetPoints(1.0)) * difficulty; //summerar domarpoäng och multiplicerar med hoppets svårighet
            return TotJ;
        }
        ...
        public void Connect_judges_and_start_contest() //TESTFUNKTION FÖR SERVER
        {
